...
[ExecuteInEditMode]
[AddComponentMenu("Custom/Black Hole")]
[System.Serializable]
public class BlackHoleOwner : MonoBehaviour
{
    [HideInInspector] public Material ForceMaterial;
    [HideInInspector] public bool ActiveChange = true;
    private string shader = "Custom/BlackHoleOwner";
...
#if UNITY_EDITOR
[CustomEditor(typeof(BlackHoleOwner)), CanEditMultipleObjects]
public class BlackHoleOwner_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        BlackHoleOwner _2dxScript = (BlackHoleOwner)target;
